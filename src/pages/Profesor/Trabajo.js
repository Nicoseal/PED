    ...
    return(
        <Container maxWidth="md">
            <Paper className={classes.paper}>
                <Typography component="h1" variant="h3">Crear Trabajo</Typography>
                <Typography className={classes.midText} variant="body1">Para crear un nuevo trabajo porfavor complete los siguientes campos:</Typography>
            </Paper>
